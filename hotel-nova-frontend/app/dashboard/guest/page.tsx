...
export default function GuestDashboardPage() {
  ...
  const UPCOMING_BOOKINGS = GUEST_BOOKINGS.filter(
    b =>
      b.status === 'confirmed' ||
      b.status === 'checked-in' ||
      b.status === 'pending'
      ...
      <div className="bg-white rounded-lg border border-[#E2E8F0] mb-6">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-t border-[#E2E8F0]">
          <p className="text-[13px] text-[#64748B]">
            {GUEST_DASHBOARD_MESSAGES.showingOf} {GUEST_BOOKINGS.length}{' '}
            {GUEST_DASHBOARD_MESSAGES.ofLabel} {GUEST_BOOKINGS.length}{' '}
