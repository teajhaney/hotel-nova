    ...
    <div className="page-container py-10 md:py-12">
      ...
      <div className="mb-8">
        <div className="flex items-start justify-between gap-4 mb-3">
          <h1 className="text-[32px] md:text-[40px] lg:text-[44px] font-bold text-[#0D0F2B] leading-tight">
          ...
          <button
            ...
            className="md:hidden shrink-0 inline-flex items-center gap-2 px-4 py-2.5
                       ...
                       rounded-lg hover:bg-[#030A6F] transition-colors mt-1"
          >
            <SlidersHorizontal size={16} aria-hidden="true" />
            {OFFERS_PAGE_MESSAGES.filterButton}
          </button>
        </div>
        <p className="text-[16px] md:text-[17px] text-[#64748B] leading-relaxed text-justify">
