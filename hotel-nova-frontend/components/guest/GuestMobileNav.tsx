...
const MOBILE_NAV = [
  ...
  },
  {
    ...
    label: GUEST_DASHBOARD_MESSAGES.mobileReviews,
    icon: Star,
    badge: true,
  },
  {
    href: '/dashboard/guest/profile',
    label: GUEST_DASHBOARD_MESSAGES.mobileProfile,
    icon: User,
  },
];
...
export function GuestMobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#E2E8F0] lg:hidden animate-slide-up">
