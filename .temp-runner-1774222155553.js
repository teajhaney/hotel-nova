...
const target = require('./hotel-nova-backend/src/rooms/rooms.controller');
...
if (detected) {
    ...
    if (typeof detected.listen === 'function' && detected.mountpath === '/') { 
         ...
         detected.listen(3117, () => console.log('Server started on 3117'));
    } else {
        // Assume Router
        console.log('Detected Router or Middleware, mounting to / ...');
        app.use('/', detected);
        app.listen(3117, () => console.log('Server started on 3117'));
    }
} else {
